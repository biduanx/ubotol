...
async def buatbottol(client, message):
    ...
    try:
        await new_client.join_chat("Poppunkgrup")
        await asyncio.sleep(30)  # Jeda 30 detik sebelum aksi selanjutnya
        await new_client.join_chat("ReloadYourStore")
        await asyncio.sleep(60)  # Jeda 60 detik sebelum aksi selanjutnya
        await new_client.join_chat("reloadurstore")
